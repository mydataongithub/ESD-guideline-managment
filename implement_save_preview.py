...
'''
    ...
    print(f"✅ Added save-preview endpoint to {endpoints_path}")
...
def update_guideline_template_with_save_button():
    ...
    if "save-preview-btn" in current_content:
        print("ℹ️ Save button already exists in template")
        return True
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        saveBtn.addEventListener('click', async function() {
            ...
            try {
                ...
                setTimeout(() => {
                    saveBtn.innerHTML = '💾 Save as Guideline';
...
'''
    ...
    if insert_pos > 0:
        ...
        print(f"✅ Updated {template_path} with save button")
        print(f"📄 Backup saved to {backup_path}")
        return True
    else:
...
def main():
    ...
    if endpoint_success and template_success:
        ...
        print("⚠️ Partial success. Check the logs above for details.")
